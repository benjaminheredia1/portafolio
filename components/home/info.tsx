        ...
        content={[
          {
            title: "About Me",
            description:
              "I'm Benjamin Heredia, a junior passionate about creating innovative and efficient solutions. I specialize in Full Stack development, combining frontend and backend skills to build complete and functional web applications.",
            content: (
              <Image
                fill
                className="w-12 h-12 text-cyan-500 object-cover"
                src="/benja.jpeg"
          ...
          },
          {
            ...
            content: (
              <Image
                fill
                className="w-16 h-16 text-cyan-500 object-cover"
                src="/evento.jpeg"
                alt="event"
              />
            ),
